...
class ToolRegistry:
    ...
    def list_for_personality(cls, personality: str) -> list[Tool]:
        ...
        tools = [
            ...
            if getattr(t, affinity_attr) != ToolAffinity.AVOIDED
        ]
        return sorted(
            tools,
...
def _register_base_tools():
    ...
    base_tools = [
        # RECON
        Tool(
            "nmap_scan", ToolCategory.RECON, "TCP/UDP port scan with service detection",
            ...
            stealth_level=0.1, speed=0.3,
            tags=["scan", "network"],
        ),
        Tool(
            "passive_recon", ToolCategory.RECON, "OSINT — DNS, WHOIS, SSL, Shodan, Censys",
            ...
            stealth_level=1.0, speed=0.5,
            tags=["osint", "stealth"],
        ),
        # EXPLOIT
        Tool(
            "nuclei_scan", ToolCategory.EXPLOIT, "10,000+ template vulnerability scanner",
            psychopathy_affinity=ToolAffinity.PRIMARY,
            narcissism_affinity=ToolAffinity.FAVORED,
            machiavellianism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.2, speed=0.6, risk_level=0.7,
            tags=["scan", "vuln", "cve"],
        ),
        Tool(
            "custom_exploit", ToolCategory.EXPLOIT, "AI-generated exploit execution",
            ...
            stealth_level=0.3, speed=0.4, risk_level=0.9,
            tags=["ai", "exploit", "0day"],
        ),
        # POST-EXPLOIT
        Tool(
            "hashdump", ToolCategory.CREDENTIAL, "Dump password hashes (SAM, LSASS, NTDS)",
            psychopathy_affinity=ToolAffinity.PRIMARY,
            narcissism_affinity=ToolAffinity.FAVORED,
            machiavellianism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.3, speed=0.7, risk_level=0.8,
            tags=["credential", "windows"],
        ),
        Tool(
            "kerberoast", ToolCategory.CREDENTIAL, "Kerberoasting attack extraction",
            psychopathy_affinity=ToolAffinity.FAVORED,
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            narcissism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.6, speed=0.5, risk_level=0.4,
            tags=["ad", "kerberos", "credential"],
        ),
        # LATERAL
        Tool(
            "psexec", ToolCategory.LATERAL, "Remote execution via SMB",
            psychopathy_affinity=ToolAffinity.PRIMARY,
            narcissism_affinity=ToolAffinity.FAVORED,
            machiavellianism_affinity=ToolAffinity.AVOIDED,
            stealth_level=0.2, speed=0.8, risk_level=0.6,
            tags=["smb", "windows", "lateral"],
        ),
        Tool(
            "wmi_exec", ToolCategory.LATERAL, "WMI-based lateral movement",
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            psychopathy_affinity=ToolAffinity.FAVORED,
            narcissism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.7, speed=0.6, risk_level=0.4,
            tags=["wmi", "windows", "lateral", "stealth"],
        ),
        # EVASION
        Tool(
            "obfuscate_payload", ToolCategory.EVASION, "Polymorphic payload mutation",
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            psychopathy_affinity=ToolAffinity.FAVORED,
            narcissism_affinity=ToolAffinity.AVOIDED,
            stealth_level=0.9, speed=0.4, risk_level=0.1,
            tags=["evasion", "payload", "stealth"],
        ),
        # C2
        Tool(
            "sliver_deploy", ToolCategory.C2, "Deploy Sliver C2 implant",
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            psychopathy_affinity=ToolAffinity.FAVORED,
            narcissism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.8, speed=0.5, risk_level=0.3,
            tags=["c2", "implant", "sliver"],
        ),
        Tool(
            "havoc_deploy", ToolCategory.C2, "Deploy Havoc C2 Demon agent",
            psychopathy_affinity=ToolAffinity.PRIMARY,
            narcissism_affinity=ToolAffinity.FAVORED,
            machiavellianism_affinity=ToolAffinity.NEUTRAL,
            stealth_level=0.5, speed=0.6, risk_level=0.4,
            tags=["c2", "implant", "havoc"],
        ),
        # EXFIL
        Tool(
            "stealth_exfil", ToolCategory.EXFIL, "DNS/HTTPS tunneling exfiltration",
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            psychopathy_affinity=ToolAffinity.NEUTRAL,
            narcissism_affinity=ToolAffinity.AVOIDED,
            stealth_level=1.0, speed=0.3, risk_level=0.2,
            tags=["exfil", "stealth", "tunnel"],
        ),
        # DECEPTION
        Tool(
            "deploy_honeypot", ToolCategory.DECEPTION, "Deploy decoy honeypot",
            machiavellianism_affinity=ToolAffinity.PRIMARY,
            psychopathy_affinity=ToolAffinity.AVOIDED,
            narcissism_affinity=ToolAffinity.AVOIDED,
            stealth_level=0.9, speed=0.3, risk_level=0.1,
